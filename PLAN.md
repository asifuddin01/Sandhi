...
- [ ] Build the admin dashboard and every specified content, member, applications, approvals, settings, and audit manager. (Dashboard, members, settings, audit, research, projects, news, events, opportunities, resources, and partners are built on the shared content framework; publications with DOI and arXiv import, insights review, image uploads, applications, and approvals remain.)
