...
- [ ] Build the admin dashboard and every specified content, member, applications, approvals, settings, and audit manager. (Dashboard, members, settings, audit, news, events, opportunities, resources, and partners are built on the shared content framework; research, projects, publications, insights, image uploads, applications, and approvals remain.)
